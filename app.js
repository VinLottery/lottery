...
function createTicket(ticketIndex) {
    ...
    numberGrid70.classList.add("number-grid");
    for (let i = 1; i <= 70; i++) {
    ...
    numberGrid25.classList.add("number-grid");
    for (let i = 1; i <= 25; i++) {
